...
#Case H
    if option == 'H':
        ...
        if maximum_value > 89.5:
            ...
            highest_letter = 'D'
        elif 59.5 > maximum_value and maximum_value >= 0 or lab_avg < 59.5:
            highest_letter = 'F'
...
#Case S
    if option == 'S':
        ...
        elif not possible_lowest_final <= 100 and not lab_avg >= 59.5:
