...
#Case H
    if option == 'H':
        ...
        if maximum_value > 89.5:
            ...
            highest_letter = 'D'
        elif maximum_value < 59.5 or lab_avg < 59.5:
            highest_letter = 'F'
...
#Case S
    if option == 'S':
        ...
        elif not possible_lowest_final <= 100 or not lab_avg >= 60:
